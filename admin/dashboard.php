...
$fetch = mysqli_query($conn,"SELECT * FROM makoonspune_enquiries");
...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
                          ...
                          <div class="card-block">
                              <div class="media">
                                  <div class="media-body text-xs-left">
                                      <h3 class="deep-orange"><?php if(isset($no_of_enquiries)): echo $no_of_enquiries; endif;?></h3>
                                      <a href="<?=$adminurl?>/enquiries.php"><span>Enquiries</span></a>
                                  </div>
    ...
    <footer class="footer footer-static footer-light navbar-border">
      All rights reserved  <i class="fa fa-love"></i><a href="https://bootstrapthemes.co">Copyright © Makoons Pune</a>
    </footer>
