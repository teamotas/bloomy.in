...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=$adminurl?>/app-assets/css/pages/login-register.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
        ...
        <div class="card border-grey border-lighten-3 m-0">
            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    <form class="form-horizontal form-simple" action="login.php" method="post" >
